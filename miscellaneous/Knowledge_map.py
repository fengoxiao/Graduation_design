#!/usr/bin/env python 
# -*- coding:utf-8 -*-
from database_interface import select_triple_table,creat_triple_table,select_triple_table_neo4j,creat_table_neo4j,record_had_extracting,table_not_exists,truncate_table_neo4j
