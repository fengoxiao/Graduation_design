...
import re
import time
from crawler.database_test_total import domestic_create_interface,domestic_retrieve_interface
# 清理html标签
def clean_tag(string):
    ...
    return dd
count=0
url_start='http://www.hellosea.net/News/2/index_{}.html'
for page in range(1,201):
    try:
        if page==1:
            url='http://www.hellosea.net/News/2/'
        else:
        ...
        for news in news_list:
            ...
            #新方法
            if not domestic_retrieve_interface(news_web_url):
                continue
