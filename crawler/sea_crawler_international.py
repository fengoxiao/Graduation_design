...
import re
import time
from crawler.database_test_total import international_create_interface,international_retrieve_interface
# 清理html标签
def clean_tag(string):
    ...
    return dd
count=0
url_start='http://www.hellosea.net/News/3/index_{}.html'
for page in range(1,121):
    try:
        if page==1:
            url='http://www.hellosea.net/News/3/'
        else:
        ...
        for news in news_list:
            ...
            #新方法
            if not international_retrieve_interface(news_web_url):
                continue
            ...
            # print(news_web_url)
            # print(news_source)
            if international_create_interface(news_title,'国际资讯',news_date,news_summary,news_content,news_web_url,news_source):
                count+=1
